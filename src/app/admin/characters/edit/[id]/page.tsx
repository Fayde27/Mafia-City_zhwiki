      ...
      <main className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-900-muted text-sm mt-1">填写角色详细信息</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="card-hard rounded-lg p-6">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-gray-900 text-sm font-bold uppercase tracking-wider mb-2">角色名称 *</label>
                  <input
                    type="text"
                    value={formData.name}
                ...
                <div>
                  <label className="block text-gray-900 text-sm font-bold uppercase tracking-wider mb-2">称号/标题</label>
                  <input
                    type="text"
            ...
            <div className="card-hard rounded-lg p-6">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-gray-900 text-sm font-bold uppercase tracking-wider mb-2">头像 URL</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-gray-900 text-sm font-bold uppercase tracking-wider mb-2">Banner URL</label>
                  <input
                    type="text"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="card-hard rounded-lg p-6">
              <h3 className="text-lg font-bold text-[#e8c547] mb-4">角色属性</h3>
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-gray-900 text-sm font-bold uppercase tracking-wider mb-2">角色定位</label>
                    <input
                      type="text"
                      value={formData.role}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-gray-900 text-sm font-bold uppercase tracking-wider mb-2">适配兵种</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-gray-900 text-sm font-bold uppercase tracking-wider mb-2">核心加成</label>
                    <input
                      type="text"
                ...
                <div>
                  <label className="block text-gray-900 text-sm font-bold uppercase tracking-wider mb-2">获取方式</label>
                  <input
                    type="text"
          ...
          <div className="card-hard rounded-lg p-6">
            <h3 className="text-lg font-bold text-[#e8c547] mb-4">角色简介</h3>
            <textarea
              value={formData.description}
              onChange={(e) => setFormData({ ...formData, description: e.target.value })}
              rows={4}
              className="w-full bg-gray-100 border-2 border-gray-200 px-4 py-3 text-gray-900 focus:border-wiki-accent focus:outline-none resize-y"
              placeholder="支持Markdown格式"
            />
          </div>

          <div className="card-hard rounded-lg p-6">
            <h3 className="text-lg font-bold text-[#e8c547] mb-4">角色属性 (Markdown)</h3>
            <textarea
          ...
          <div className="card-hard rounded-lg p-6">
            <h3 className="text-lg font-bold text-[#e8c547] mb-4">技能详情 (Markdown)</h3>
            <textarea
          ...
          <div className="card-hard rounded-lg p-6">
            <h3 className="text-lg font-bold text-[#e8c547] mb-4">黑道传闻 (Markdown)</h3>
            <textarea
          ...
          <div className="card-hard rounded-lg p-6">
            <h3 className="text-lg font-bold text-[#e8c547] mb-4">阵容搭配 (Markdown)</h3>
            <textarea
          ...
          <div className="card-hard rounded-lg p-6">
            <h3 className="text-lg font-bold text-[#e8c547] mb-4">配兵推荐 (Markdown)</h3>
            <textarea
