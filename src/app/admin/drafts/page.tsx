...
const TYPES = [
  ...
  },
  {
    key: 'characters',
    label: '角色',
    api: '/api/admin/characters?draft=true&limit=100',
    dataKey: 'characters',
    nameKey: 'name',
    editPath: (id: string) => `/admin/characters/edit/${id}`,
    publishApi: (id: string) => `/api/admin/characters/${id}`,
    publishBody: (item: DraftItem) => ({ isPublished: true }),
    categoryKey: 'CharacterCategory',
  },
  {
    key: 'buildings',
    label: '建築',
    api: '/api/admin/buildings?draft=true&limit=100',
    dataKey: 'buildings',
    nameKey: 'name',
    editPath: () => `/admin/buildings`,
    publishApi: (id: string) => `/api/admin/buildings/${id}`,
    publishBody: (item: DraftItem) => ({ isPublished: true }),
    categoryKey: 'BuildingCategory',
  },
  {
    key: 'equipment',
    label: '裝備',
    api: '/api/admin/equipment?draft=true&limit=100',
    dataKey: 'equipment',
    nameKey: 'name',
    editPath: () => `/admin/equipment`,
    publishApi: (id: string) => `/api/admin/equipment/${id}`,
    publishBody: (item: DraftItem) => ({ isPublished: true }),
    categoryKey: 'EquipmentCategory',
  },
  {
    key: 'items',
    label: '道具',
  ...
  },
  {
    key: 'troops',
    label: '兵種',
    api: '/api/admin/troops?draft=true&limit=100',
    dataKey: 'troops',
    nameKey: 'name',
    editPath: () => `/admin/troops`,
    publishApi: (id: string) => `/api/admin/troops/${id}`,
    publishBody: (item: DraftItem) => ({ isPublished: true }),
    categoryKey: 'TroopCategory',
  },
]
