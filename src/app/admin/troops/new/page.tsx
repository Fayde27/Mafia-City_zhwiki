      ...
      <main className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-900-muted text-sm mt-1">填写兵种详细信息</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="card-hard rounded-lg p-6">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-gray-900 text-sm font-bold uppercase tracking-wider mb-2">兵种名称 *</label>
                  <input
                    type="text"
                    value={formData.name}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="card-hard rounded-lg p-6">
              <h3 className="text-lg font-bold text-[#e8c547] mb-4">兵种属性</h3>
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-gray-900 text-sm font-bold uppercase tracking-wider mb-2">兵种类型</label>
                    <input
                      type="text"
                      value={formData.type}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-gray-900 text-sm font-bold uppercase tracking-wider mb-2">攻击力</label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label className="block text-gray-900 text-sm font-bold uppercase tracking-wider mb-2">防御力</label>
                    <input
                      type="number"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-gray-900 text-sm font-bold uppercase tracking-wider mb-2">生命值</label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label className="block text-gray-900 text-sm font-bold uppercase tracking-wider mb-2">速度</label>
                    <input
                      type="number"
          ...
          <div className="card-hard rounded-lg p-6">
            <h3 className="text-lg font-bold text-[#e8c547] mb-4">兵种简介 (Markdown)</h3>
            <textarea
          ...
          <div className="card-hard rounded-lg p-6">
            <h3 className="text-lg font-bold text-[#e8c547] mb-4">克制信息 (Markdown)</h3>
            <textarea
