      ...
      <main className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-wiki-text-muted text-sm mt-1">管理道具圖鑑內容，新增、編輯或刪除道具</p>
          </div>
            ...
            <table className="w-full">
              <thead className="bg-wiki-gray">
                <tr>
                  ...
                  <th className="text-left px-6 py-4 text-wiki-accent font-bold uppercase tracking-wider text-sm">品質</th>
