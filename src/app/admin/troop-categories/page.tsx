      ...
      <main className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-wiki-text-muted text-sm mt-1">管理兵种图鉴分类，新增、编辑或删除分类</p>
          </div>
            ...
            <table className="w-full">
              <thead className="bg-wiki-gray">
                <tr>
                  ...
                  <th className="text-left px-6 py-4 text-wiki-accent font-bold uppercase tracking-wider text-sm">兵种数</th>
