        ...
        {(rarityOptions.length > 0 || roleOptions.length > 0 || weaponOptions.length > 0) && (
          <div className="card-hard rounded-lg p-4 md:p-6 mb-6 space-y-4">
            ...
            {roleOptions.length > 0 && (
              <div>
                <div className="text-sm font-bold text-[#e8c547] uppercase tracking-wider mb-2">角色定位</div>
                <div className="flex flex-wrap gap-2">
                  <button
            ...
            {weaponOptions.length > 0 && (
              <div>
                <div className="text-sm font-bold text-[#e8c547] uppercase tracking-wider mb-2">适配兵种</div>
                <div className="flex flex-wrap gap-2">
                  <button
            ...
            {filteredCharacters.map((character) => (
              ...
              >
                <div className="relative h-48 md:h-56 overflow-hidden bg-gradient-to-br from-wiki-gray to-wiki-darker">
                  {character.banner ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center">
                      <span className="text-6xl text-gray-900-muted">{character.name[0]}</span>
                    </div>
                  )}
                ...
                <div className="p-4 md:p-5">
                  ...
                  {character.title && (
                    <p className="text-gray-900-muted text-sm mb-2">{character.title}</p>
                  )}
                  <div className="flex items-center gap-2 text-xs text-gray-900-muted">
                    {character.role && (
                  ...
                  {character.coreBonus && (
                    <p className="text-gray-900-muted text-xs mt-1">
