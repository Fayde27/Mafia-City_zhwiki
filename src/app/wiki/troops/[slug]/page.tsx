        ...
        {(rarityOptions.length > 0 || typeOptions.length > 0) && (
          <div className="card-hard rounded-lg p-4 md:p-6 mb-6 space-y-4">
            ...
            {typeOptions.length > 0 && (
              <div>
                <div className="text-sm font-bold text-[#e8c547] uppercase tracking-wider mb-2">兵种类型</div>
                <div className="flex flex-wrap gap-2">
                  <button
              ...
              >
                <div className="relative h-48 md:h-56 overflow-hidden bg-gradient-to-br from-wiki-gray to-wiki-darker">
                  {troop.image ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center">
                      <span className="text-6xl text-gray-900-muted">{troop.name[0]}</span>
                    </div>
                  )}
                ...
                <div className="p-4 md:p-5">
                  ...
                  {troop.counter && (
                    <p className="text-gray-900-muted text-sm mb-2">克制：{troop.counter}</p>
                  )}
                  {troop.description && (
