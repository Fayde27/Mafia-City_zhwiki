export default function WikiFooter() {
  return (
    <footer className="bg-wiki-darker border-t-2 border-wiki-accent mt-8 md:mt-12">
      <div className="container mx-auto px-4 py-6 md:py-8">
        ...
        <div className="border-t border-wiki-border mt-6 md:mt-8 pt-4 md:pt-6 text-center text-wiki-text-muted text-xs md:text-sm">
